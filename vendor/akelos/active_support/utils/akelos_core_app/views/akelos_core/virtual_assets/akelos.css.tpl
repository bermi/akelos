...
#header {
	width: 893px;
	height: 139px;
	background: url('<%= url_for :action => "images", :id => "header-bg", :format => "gif" %>') no-repeat left top;
...
.inner-blue-banner {
	...
	margin: 0 auto;
	height: 195px;
	background: url('<%= url_for :action => "images", :id => "blue-banner-img", :format => "gif" %>') no-repeat left;
	padding: 0 0 0 258px;
}
...
#col-9 {
	...
	background: url('<%= url_for :action => "images", :id => "col-9-bg", :format => "gif" %>') no-repeat top #fff;
...
.col-9-bottom {
	...
	height: 6px;
	display: block;
	background: url('<%= url_for :action => "images", :id => "col-9-botoom", :format => "gif" %>') no-repeat;
	font-size: 0;
	line-height: 0;
	float: right;
}
