...
class PEAR
{
     ...
     * @access  private
     */
    protected $_default_error_mode = null;
     ...
     * @access  private
     */
    protected $_default_error_handler = '';
     ...
     * @access  private
     */
    protected $_expected_errors = array();
     ...
     * @return void
     */
    protected function __construct($error_class = null)
    {
    ...
    */
     ...
     * @since PHP 4.3.0
     */
    protected function _checkDelExpect($error_code)
    {
        $deleted = false;
    ...
    static function staticPopErrorHandling()
    {
        $stack = &$GLOBALS['_PEAR_error_handler_stack'];
        $setmode     = &$GLOBALS['_PEAR_default_error_mode'];
        $setoptions  = &$GLOBALS['_PEAR_default_error_options'];
