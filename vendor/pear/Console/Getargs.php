...
class Console_Getargs_Options
{
     ...
     */
    public function init($config, $arguments = NULL)
    {
     ...
     * @return true|PEAR_Error
     */
    public function parseArg($arg, $isLong, &$pos)
    {
     ...
     * @return true|PEAR_Error
     */
    public function setValue($optname, $value, &$pos)
    {
     ...
     * @return void
     */
    public function updateValue($optname, $value)
    {
     ...
     */
    public function getLongName($optname)
    {
