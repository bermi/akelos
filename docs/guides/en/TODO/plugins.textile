...
class DefinitionGeneratorTest extends Test::Unit::TestCase
  ...
  private
    ...
    public function fake_akelos_root() {
...
<php>
class YaffleDefinitionGenerator extends Akelos::Generator::Base
...
<php>
class YaffleGenerator extends Akelos::Generator::NamedBase
  public function manifest() {
    m.yaffle_definition
  }
}
...
<php>
class YaffleRouteGenerator extends Akelos::Generator::Base
  public function manifest() {
    record do |m|
      m.yaffle_route
    }
...
<php>
class YaffleMigrationGenerator extends Akelos::Generator::NamedBase
  public function manifest() {
    record do |m|
