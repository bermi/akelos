...
Sintags is a template language extracted from the [[http://www.akelos.org|Akelos PHP Framework]]. The initial goal when designing the Sintags was to allow WYSIWYG HTML editor compatibility using a simplistic approach to looping collections and printing variables.
...
In this document you’ll find the following information about Sintags:
  ...
  * [[http://www.bermi.org/projects/sintags#basic|Basic Sintags syntax]]
  * [[http://www.bermi.org/projects/sintags#ruby-esque|Ruby-esque Sintags syntax]]
  * [[http://www.bermi.org/projects/sintags#integrating|Download and integrate Sintags in your project]]
  * [[http://www.bermi.org/projects/sintags#contributing|Bugs and Contributions]]
...
h2. *Downloading and installing Sintags*

You can [[http://github.com/bermi/sintags|get Sintags from Github]]

h3. Using Sintags

Using Sintags in your project is pretty straight forward.

    // include the autoloader\\ include 'src/autoload.php';\\     \\ // Create a Sintags instance\\ $Sintags = new AkSintagsParser();\\     \\ $sintags_text = '{var}';\\     \\ //Parse the sintags string\\ $php_code = $Sintags->parse($sintags_text);
...
You can register helpers in Sintags by defining the AK_SINTAGS_AVAILABLE_HELPERS constant with a serialized list of helpers.
    ...
    define('AK_SINTAGS_AVAILABLE_HELPERS', serialize(array (\\     'url_for' => 'url_helper',\\     'render' => 'controller',\\     'h' => 'text_helper',\\   )));
...
h3. Bugs and Contributions

[[http://github.com/bermi/sintags|The Project is hosted at Github]] so if you want to contribute, fork the project, make your changes and [[http://github.com/bermi/sintags/issues|open a ticket]] to let me know what you’ve fixed or implemented so I can merge it on the main repository.

Notify about bugs [[http://github.com/bermi/sintags/issues|at the git hub issues page]]