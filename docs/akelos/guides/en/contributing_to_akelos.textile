...
<php>
ActionController::Base.cache_store = :drb_store, "dphp://localhost:9192"
</php>
...
NOTE: +config.cache_store+ can be used in place of +ActionController::Base.cache_store+ in your +Akelos::Initializer.run+ block in +environment.php+
