...
class Ak
{
    ...
    */
    ...
    static function decompress($compressed_data, $format = 'gzip')
    {
    ...
    */
    ...
    static function autoload($name, $path = null)
    {
        ...
        if(empty($lib_paths)){
            $lib_paths = array(
            'ActiveRecordHelper'        =>  'AkActionView/helpers/active_record_helper.php',
            'AkActionController'        =>  'AkActionController.php',
            'AkActionMailer'            =>  'AkActionMailer.php',
            'AkActionMailerQuoting'     =>  'AkActionMailer/AkActionMailerQuoting.php',
            'AkActionView'              =>  'AkActionView.php',
            'AkActionViewHelper'        =>  'AkActionView/AkActionViewHelper.php',
            ...
            'AkActiveRecord'            =>  'AkActiveRecord.php',
            'AkActiveRecordMock'        =>  'AkActiveRecord/AkActiveRecordMock.php',
            'AkAdodbCache'              =>  'AkCache/AkAdodbCache.php',
            'AkArray'                   =>  'AkType/AkArray.php',
            'AkAssociatedActiveRecord'  =>  'AkActiveRecord/AkAssociatedActiveRecord.php',
            'AkAssociation'             =>  'AkActiveRecord/AkAssociation.php',
            'AkBaseModel'               =>  'AkBaseModel.php',
            'AkBelongsTo'               =>  'AkActiveRecord/AkAssociations/AkBelongsTo.php',
            'AkCache'                   =>  'AkCache.php',
            'AkCacheHandler'            =>  'AkActionController/AkCacheHandler.php',
            'AkCacheSweeper'            =>  'AkActionController/AkCacheSweeper.php',
            'AkClassExtender'           =>  'AkClassExtender.php',
            'AkConfig'                  =>  'AkConfig.php',
            'AkDate'                    =>  'AkType/AkDate.php',
            'AkDbAdapter'               =>  'AkActiveRecord/AkDbAdapter.php',
            'AkDbSchemaCache'           =>  'AkActiveRecord/AkDbSchemaCache.php',
            'AkDbSession'               =>  'AkDbSession.php',
            'AkDispatcher'              =>  'AkDispatcher.php',
            'AkelosTextReporter'        =>  'AkUnitTest.php',
            'AkelosVerboseTextReporter' =>  'AkUnitTest.php',
            'AkFormHelperBuilder'       =>  'AkActionView/helpers/form_helper.php',
            'AkFormHelperInstanceTag'   =>  'AkActionView/helpers/form_helper.php',
            'AkFormHelperOptionsInstanceTag'    =>  'AkActionView/helpers/form_options_helper.php',
            'AkFtp'                     =>  'AkFtp.php',
            'AkHasAndBelongsToMany'     =>  'AkActiveRecord/AkAssociations/AkHasAndBelongsToMany.php',
            'AkHasMany'                 =>  'AkActiveRecord/AkAssociations/AkHasMany.php',
            'AkHasOne'                  =>  'AkActiveRecord/AkAssociations/AkHasOne.php',
            'AkHelperLoader'            =>  'AkActionView/AkHelperLoader.php',
            'AkHttpClient'              =>  'AkHttpClient.php',
            'AkImage'                   =>  'AkImage.php',
            'AkImageColorScheme'        =>  'AkImage/AkImageColorScheme.php',
            'AkImageFilter'             =>  'AkImage/AkImageFilter.php',
            'AkInflector'               =>  'AkInflector.php',
            'AkInstaller'               =>  'AkInstaller.php',
            'AkLazyObject'              =>  'AkLazyObject.php',
            'AkLexer'                   =>  'AkLexer.php',
            'AkLocaleManager'           =>  'AkLocaleManager.php',
            'AkMailBase'                =>  'AkActionMailer/AkMailBase.php',
            'AkMailComposer'            =>  'AkActionMailer/AkMailComposer.php',
            'AkMailEncoding'            =>  'AkActionMailer/AkMailEncoding.php',
            'AkMailMessage'             =>  'AkActionMailer/AkMailMessage.php',
            'AkMailParser'              =>  'AkActionMailer/AkMailParser.php',
            'AkMailPart'                =>  'AkActionMailer/AkMailPart.php',
            'AkMemcache'                =>  'AkCache/AkMemcache.php',
            'AkNumber'                  =>  'AkType/AkNumber.php',
            'AkObject'                  =>  'AkObject.php',
            'AkObserver'                =>  'AkActiveRecord/AkObserver.php',
            'AkPhpCodeSanitizer'        =>  'AkActionView/AkPhpCodeSanitizer.php',
            'AkPhpTemplateHandler'      =>  'AkActionView/AkPhpTemplateHandler.php',
            'AkPlugin'                  =>  'AkPlugin.php',
            'AkPluginInstaller'         =>  'AkPluginInstaller.php',
            'AkPluginLoader'            =>  'AkPlugin.php',
            'AkPluginManager'           =>  'AkPlugin/AkPluginManager.php',
            'AkProfiler'                =>  'AkProfiler.php',
            'AkReflection'              =>  'AkReflection.php',
            'AkReflectionClass'         =>  'AkReflection/AkReflectionClass.php',
            'AkReflectionDocBlock'      =>  'AkReflection/AkReflectionDocBlock.php',
            'AkReflectionFile'          =>  'AkReflection/AkReflectionFile.php',
            'AkReflectionFunction'      =>  'AkReflection/AkReflectionFunction.php',
            'AkReflectionMethod'        =>  'AkReflection/AkReflectionMethod.php',
            'AkRequest'                 =>  'AkRequest.php',
            'AkRequestMimeType'         =>  'AkRequestMimeType.php',
            'AkResponse'                =>  'AkResponse.php',
            'AkRouter'                  =>  'AkRouter.php',
            'AkSession'                 =>  'AkSession.php',
            'AkSintags'                 =>  'AkActionView/TemplateEngines/AkSintags.php',
            'AkSintagsLexer'            =>  'AkActionView/TemplateEngines/AkSintags/AkSintagsLexer.php',
            'AkSintagsParser'           =>  'AkActionView/TemplateEngines/AkSintags/AkSintagsParser.php',
            'AkString'                  =>  'AkType/AkString.php',
            'AkTestApplication'         =>  'AkUnitTest/AkTestApplication.php',
            'AkTestDispatcher'          =>  'AkUnitTest/AkTestDispatcher.php',
            'AkTestRequest'             =>  'AkUnitTest/AkTestRequest.php',
            'AkTestResponse'            =>  'AkUnitTest/AkTestResponse.php',
            'AkTime'                    =>  'AkType/AkTime.php',
            'AkTimeZone'                =>  'AkLocalize/AkTimeZone.php',
            'AkType'                    =>  'AkType.php',
            'AkUnitTest'                =>  'AkUnitTest.php',
            'AkUnitTestSuite'           =>  'AkUnitTestSuite.php',
            'AkWebTestCase'             =>  'AkUnitTest.php',
            'AssetTagHelper'            =>  'AkActionView/helpers/asset_tag_helper.php',
            'FormHelper'                =>  'AkActionView/helpers/form_helper.php',
            'FormTagHelper'             =>  'AkActionView/helpers/form_tag_helper.php',
            'JavascriptHelper'          =>  'AkActionView/helpers/javascript_helper.php',
            'JavascriptMacrosHelper'    =>  'AkActionView/helpers/javascript_macros_helper.php',
            'MailHelper'                =>  'AkActionView/helpers/mail_helper.php',
            'MenuHelper'                =>  'AkActionView/helpers/menu_helper.php',
            'NumberHelper'              =>  'AkActionView/helpers/number_helper.php',
            'PaginationHelper'          =>  'AkActionView/helpers/pagination_helper.php',
            'PrototypeHelper'           =>  'AkActionView/helpers/prototype_helper.php',
            'ScriptaculousHelper'       =>  'AkActionView/helpers/scriptaculous_helper.php',
            'TextHelper'                =>  'AkActionView/helpers/text_helper.php',
            'UrlHelper'                 =>  'AkActionView/helpers/url_helper.php',
            'XmlHelper'                 =>  'AkActionView/helpers/xml_helper.php',
            );
        }
