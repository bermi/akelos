...
class ADODB_DataDict {
    ...
    function MetaTables()
    {
        ...
        $previous_state = $this->connection->transOff;
        $this->connection->transOff = 1;
        $result = $this->connection->MetaTables();
        $this->connection->transOff = $previous_state;
        return $result;
    }
    ...
    function MetaColumns($tab, $upper=true, $schema=false)
    {
        ...
        $previous_state = $this->connection->transOff;
        $this->connection->transOff = 1;
        $result = $this->connection->MetaColumns($this->TableName($tab), $upper, $schema);
        $this->connection->transOff = $previous_state;
        return $result;
    }
