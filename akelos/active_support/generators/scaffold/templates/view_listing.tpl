<div id="sidebar">
  <h1>_{Tasks}:</h1>
  <ul>
    <li><?php  echo '<?php  echo  '?>$url_helper->link_to($text_helper->translate('Create new <?php  echo AkInflector::humanize($singular_name)?>'), array('action' => 'add'))?></li>
  </ul> 
</div>
...
<div id="content">
  ...
  <tr>
    ...
    {loop content_columns}
        <th scope="col"><?php  echo '<?php  echo  '?>$pagination_helper->sortable_link($content_column) ?></th>
    {end}
  ...
  {loop <?php  echo $plural_name?>}
    ...
    {end}
      <td class="operation"><?php  echo '<?php  echo  '.$helper_var_name?>->link_to_show($<?php  echo $singular_name?>)?></td>
      <td class="operation"><?php  echo '<?php  echo  '.$helper_var_name?>->link_to_edit($<?php  echo $singular_name?>)?></td>
      <td class="operation"><?php  echo '<?php  echo  '.$helper_var_name?>->link_to_destroy($<?php  echo $singular_name?>)?></td>    
    </tr>
  {end}
   </table>
  </div>
