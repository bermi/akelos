...
<xsl:template match="testsuites">
    <html>
        <head>
            <title>Unit Test Results for <xsl:value-of select="@php-version"/> on <xsl:value-of select="@backend"/></title>
    <style type="text/css">
    body {
    ...
    <xsl:template name="packages">
        ...
        <xsl:for-each select="/testsuites/testsuite[not(./@name = preceding-sibling::testsuite/@package)]">
            <xsl:sort select="@package"/>
                <a name="{@package}"></a>
...
<xsl:template name="pageHeader">
    <h1>Unit Test Results for <xsl:value-of select="@php-version"/> on <xsl:value-of select="@backend"/></h1>
    <table width="100%">
    <tr>
        <td align="left"></td>
