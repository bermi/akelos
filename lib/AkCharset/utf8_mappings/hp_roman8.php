...
/**
*@file hp_roman8.php
* HP-ROMAN8 Mapping and Charset implementation.
*
*/
...
/**
* HP-ROMAN8  driver for Charset Class
*
* Charset::hp_roman8 provides functionality to convert
* HP-ROMAN8 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class hp_roman8 extends AkCharset
{
	...
	/**
	* HP-ROMAN8 to UTF-8 mapping array.
	*
	* @access private
	* @var    array    $_toUtfMap
	*/
	...
	/**
	*  UTF-8 to HP-ROMAN8 mapping array.
	*
	* @access private
	...
	*/
	...
	/**
	* Encodes given HP-ROMAN8 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string HP-ROMAN8 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into HP-ROMAN8
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    HP-ROMAN8 string data
	*/
