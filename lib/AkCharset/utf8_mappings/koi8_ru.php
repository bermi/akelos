...
/**
*@file koi8_ru.php
* KOI8-RU Mapping and Charset implementation.
*
*/
...
/**
* KOI8-RU  driver for Charset Class
*
* Charset::koi8_ru provides functionality to convert
* KOI8-RU strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class koi8_ru extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given KOI8-RU string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string KOI8-RU string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into KOI8-RU
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    KOI8-RU string data
	*/
