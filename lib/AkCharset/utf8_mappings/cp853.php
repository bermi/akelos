...
/**
*@file cp853.php
* CP853 Mapping and Charset implementation.
*
*/
...
/**
* CP853  driver for Charset Class
*
* Charset::cp853 provides functionality to convert
* CP853 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp853 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP853 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP853 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP853
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP853 string data
	*/
