...
/**
*@file cp865.php
* CP865 Mapping and Charset implementation.
*
*/
...
/**
* CP865  driver for Charset Class
*
* Charset::cp865 provides functionality to convert
* CP865 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp865 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP865 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP865 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP865
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP865 string data
	*/
