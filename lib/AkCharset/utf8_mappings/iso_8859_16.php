...
/**
*@file iso_8859_16.php
* ISO-8859-16 Mapping and Charset implementation.
*
*/
...
/**
* ISO-8859-16  driver for Charset Class
*
* Charset::iso_8859_16 provides functionality to convert
* ISO-8859-16 strings, to UTF-8 multibyte format and vice versa.
*
...
*/
class iso_8859_16 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given ISO-8859-16 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ISO-8859-16 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ISO-8859-16
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ISO-8859-16 string data
	*/
