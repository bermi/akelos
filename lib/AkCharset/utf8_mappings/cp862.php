...
/**
*@file cp862.php
* CP862 Mapping and Charset implementation.
*
*/
...
/**
* CP862  driver for Charset Class
*
* Charset::cp862 provides functionality to convert
* CP862 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp862 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP862 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP862 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP862
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP862 string data
	*/
