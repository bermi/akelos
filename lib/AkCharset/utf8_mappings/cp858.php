...
/**
*@file cp858.php
* CP858 Mapping and Charset implementation.
*
*/
...
/**
* CP858  driver for Charset Class
*
* Charset::cp858 provides functionality to convert
* CP858 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp858 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP858 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP858 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP858
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP858 string data
	*/
