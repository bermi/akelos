...
/**
*@file cp850.php
* CP850 Mapping and Charset implementation.
*
*/
...
/**
* CP850  driver for Charset Class
*
* Charset::cp850 provides functionality to convert
* CP850 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp850 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP850 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP850 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP850
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP850 string data
	*/
