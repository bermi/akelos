...
/**
*@file cp874.php
* CP874 Mapping and Charset implementation.
*
*/
...
/**
* CP874  driver for Charset Class
*
* Charset::cp874 provides functionality to convert
* CP874 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp874 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP874 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP874 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP874
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP874 string data
	*/
