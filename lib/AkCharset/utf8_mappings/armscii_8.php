...
/**
*@file armscii_8.php
* ARMSCII-8 Mapping and Charset implementation.
*
*/
...
/**
* ARMSCII-8  driver for Charset Class
*
* Charset::armscii_8 provides functionality to convert
* ARMSCII-8 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class armscii_8 extends AkCharset
{
	...
	/**
	* ARMSCII-8 to UTF-8 mapping array.
	*
	* @access private
	* @var    array    $_toUtfMap
	*/
	...
	/**
	*  UTF-8 to ARMSCII-8 mapping array.
	*
	* @access private
	...
	*/
	...
	/**
	* Encodes given ARMSCII-8 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ARMSCII-8 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ARMSCII-8
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ARMSCII-8 string data
	*/
