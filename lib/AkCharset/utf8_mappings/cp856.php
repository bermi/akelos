...
/**
*@file cp856.php
* CP856 Mapping and Charset implementation.
*
*/
...
/**
* CP856  driver for Charset Class
*
* Charset::cp856 provides functionality to convert
* CP856 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp856 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP856 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP856 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP856
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP856 string data
	*/
