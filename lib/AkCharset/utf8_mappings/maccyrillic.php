...
/**
*@file maccyrillic.php
* MacCyrillic Mapping and Charset implementation.
*
*/
...
/**
* MacCyrillic  driver for Charset Class
*
* Charset::maccyrillic provides functionality to convert
* MacCyrillic strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class maccyrillic extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given MacCyrillic string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string MacCyrillic string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into MacCyrillic
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    MacCyrillic string data
	*/
