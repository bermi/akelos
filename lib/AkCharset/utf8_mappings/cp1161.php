...
/**
*@file cp1161.php
* CP1161 Mapping and Charset implementation.
*
*/
...
/**
* CP1161  driver for Charset Class
*
* Charset::cp1161 provides functionality to convert
* CP1161 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1161 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1161 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1161 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP1161
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP1161 string data
	*/
