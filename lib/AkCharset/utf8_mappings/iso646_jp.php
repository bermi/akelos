...
/**
*@file iso646_jp.php
* ISO646-JP Mapping and Charset implementation.
*
*/
...
/**
* ISO646-JP  driver for Charset Class
*
* Charset::iso646_jp provides functionality to convert
* ISO646-JP strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class iso646_jp extends AkCharset
{
	...
	/**
	* ISO646-JP to UTF-8 mapping array.
	*
	* @access private
	* @var    array    $_toUtfMap
	*/
	...
	/**
	*  UTF-8 to ISO646-JP mapping array.
	*
	* @access private
	...
	*/
	...
	/**
	* Encodes given ISO646-JP string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ISO646-JP string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ISO646-JP
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ISO646-JP string data
	*/
