...
/**
*@file cp1252.php
* CP1252 Mapping and Charset implementation.
*
*/
...
/**
* CP1252  driver for Charset Class
*
* Charset::cp1252 provides functionality to convert
* CP1252 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1252 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1252 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1252 string
