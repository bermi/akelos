...
/**
*@file iso_8859_7.php
* ISO-8859-7 Mapping and Charset implementation.
*
*/
...
/**
* ISO-8859-7  driver for Charset Class
*
* Charset::iso_8859_7 provides functionality to convert
* ISO-8859-7 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class iso_8859_7 extends AkCharset
{
	...
	/**
	* ISO-8859-7 to UTF-8 mapping array.
	*
	* @access private
	* @var    array    $_toUtfMap
	*/
	...
	/**
	*  UTF-8 to ISO-8859-7 mapping array.
	*
	* @access private
	...
	*/
	...
	/**
	* Encodes given ISO-8859-7 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ISO-8859-7 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ISO-8859-7
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ISO-8859-7 string data
	*/
