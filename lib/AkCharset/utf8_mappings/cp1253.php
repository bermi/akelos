...
/**
*@file cp1253.php
* CP1253 Mapping and Charset implementation.
*
*/
...
/**
* CP1253  driver for Charset Class
*
* Charset::cp1253 provides functionality to convert
* CP1253 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1253 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1253 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1253 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP1253
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP1253 string data
	*/
