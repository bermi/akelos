...
/**
*@file tis_620.php
* TIS-620 Mapping and Charset implementation.
*
*/
...
/**
* TIS-620  driver for Charset Class
*
* Charset::tis_620 provides functionality to convert
* TIS-620 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class tis_620 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given TIS-620 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string TIS-620 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into TIS-620
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    TIS-620 string data
	*/
