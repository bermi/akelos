...
/**
*@file cp1254.php
* CP1254 Mapping and Charset implementation.
*
*/
...
/**
* CP1254  driver for Charset Class
*
* Charset::cp1254 provides functionality to convert
* CP1254 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1254 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1254 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1254 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP1254
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP1254 string data
	*/
