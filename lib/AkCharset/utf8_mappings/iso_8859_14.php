...
/**
*@file iso_8859_14.php
* ISO-8859-14 Mapping and Charset implementation.
*
*/
...
/**
* ISO-8859-14  driver for Charset Class
*
* Charset::iso_8859_14 provides functionality to convert
* ISO-8859-14 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class iso_8859_14 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given ISO-8859-14 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ISO-8859-14 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ISO-8859-14
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ISO-8859-14 string data
	*/
