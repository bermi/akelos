...
/**
*@file cp861.php
* CP861 Mapping and Charset implementation.
*
*/
...
/**
* CP861  driver for Charset Class
*
* Charset::cp861 provides functionality to convert
* CP861 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp861 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP861 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP861 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP861
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP861 string data
	*/
