...
/**
*@file koi8_t.php
* KOI8-T Mapping and Charset implementation.
*
*/
...
/**
* KOI8-T  driver for Charset Class
*
* Charset::koi8_t provides functionality to convert
* KOI8-T strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class koi8_t extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given KOI8-T string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string KOI8-T string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into KOI8-T
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    KOI8-T string data
	*/
