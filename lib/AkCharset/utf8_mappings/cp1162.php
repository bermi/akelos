...
/**
*@file cp1162.php
* CP1162 Mapping and Charset implementation.
*
*/
...
/**
* CP1162  driver for Charset Class
*
* Charset::cp1162 provides functionality to convert
* CP1162 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1162 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1162 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1162 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP1162
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP1162 string data
	*/
