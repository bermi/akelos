...
/**
*@file cp860.php
* CP860 Mapping and Charset implementation.
*
*/
...
/**
* CP860  driver for Charset Class
*
* Charset::cp860 provides functionality to convert
* CP860 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp860 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP860 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP860 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP860
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP860 string data
	*/
