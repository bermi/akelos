...
/**
*@file cp869.php
* CP869 Mapping and Charset implementation.
*
*/
...
/**
* CP869  driver for Charset Class
*
* Charset::cp869 provides functionality to convert
* CP869 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp869 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP869 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP869 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP869
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP869 string data
	*/
