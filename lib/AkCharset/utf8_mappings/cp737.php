...
/**
*@file cp737.php
* CP737 Mapping and Charset implementation.
*
*/
...
/**
* CP737  driver for Charset Class
*
* Charset::cp737 provides functionality to convert
* CP737 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp737 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP737 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP737 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP737
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP737 string data
	*/
