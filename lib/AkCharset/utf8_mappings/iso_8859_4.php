...
/**
*@file iso_8859_4.php
* ISO-8859-4 Mapping and Charset implementation.
*
*/
...
/**
* ISO-8859-4  driver for Charset Class
*
* Charset::iso_8859_4 provides functionality to convert
...
*/
class iso_8859_4 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given ISO-8859-4 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string ISO-8859-4 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into ISO-8859-4
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    ISO-8859-4 string data
	*/
