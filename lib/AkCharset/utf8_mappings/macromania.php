...
/**
*@file macromania.php
* MacRomania Mapping and Charset implementation.
*
*/
...
/**
* MacRomania  driver for Charset Class
*
* Charset::macromania provides functionality to convert
* MacRomania strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class macromania extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given MacRomania string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string MacRomania string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into MacRomania
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    MacRomania string data
	*/
