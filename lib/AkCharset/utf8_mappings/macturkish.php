...
/**
*@file macturkish.php
* MacTurkish Mapping and Charset implementation.
*
*/
...
/**
* MacTurkish  driver for Charset Class
*
* Charset::macturkish provides functionality to convert
* MacTurkish strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class macturkish extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given MacTurkish string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string MacTurkish string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into MacTurkish
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    MacTurkish string data
	*/
