...
/**
*@file cp1125.php
* CP1125 Mapping and Charset implementation.
*
*/
...
/**
* CP1125  driver for Charset Class
*
* Charset::cp1125 provides functionality to convert
* CP1125 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class cp1125 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP1125 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP1125 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP1125
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP1125 string data
	*/
