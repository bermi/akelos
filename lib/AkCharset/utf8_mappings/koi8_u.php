...
/**
*@file koi8_u.php
* KOI8-U Mapping and Charset implementation.
*
*/
...
/**
* KOI8-U  driver for Charset Class
*
* Charset::koi8_u provides functionality to convert
* KOI8-U strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class koi8_u extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given KOI8-U string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string KOI8-U string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into KOI8-U
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    KOI8-U string data
	*/
