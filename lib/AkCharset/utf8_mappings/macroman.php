...
/**
*@file macroman.php
* MacRoman Mapping and Charset implementation.
*
*/
...
/**
* MacRoman  driver for Charset Class
*
* Charset::macroman provides functionality to convert
* MacRoman strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
*/
class macroman extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given MacRoman string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string MacRoman string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into MacRoman
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    MacRoman string data
	*/
