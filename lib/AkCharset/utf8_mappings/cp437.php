...
/**
*@file cp437.php
* CP437 Mapping and Charset implementation.
*
*/
...
/**
* CP437  driver for Charset Class
*
* Charset::cp437 provides functionality to convert
* CP437 strings, to UTF-8 multibyte format and vice versa.
*
* @package AKELOS
* @subpackage Localize
...
class cp437 extends AkCharset
{
	...
	*/
	...
	/**
	* Encodes given CP437 string into UFT-8
	*
	* @access public
	* @see UtfDecode
	* @param    string    $string CP437 string
	...
	*/
	...
	/**
	* Decodes given UFT-8 string into CP437
	*
	* @access public
	* @see UtfEncode
	* @param    string    $string UTF-8 string
	* @return    string    CP437 string data
	*/
