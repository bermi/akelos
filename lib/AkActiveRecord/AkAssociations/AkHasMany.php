 ...
 *  * 'counter_sql' - specifySELECT * FROM messages WHERE messages.sender_id = 1 ORDER BY created_at DESC a complete SQL statement to fetch the size of the association. If +'finder_sql'+ is specified but +'counter_sql'+, +'counter_sql'+ will be generated by replacing SELECT ? FROM with SELECT COUNT(*) FROM.
