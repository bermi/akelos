    ...
    */
    ...
    static function autoload($name, $path = null)
    {
        ...
        if(empty($paths)){
            ...
            'AkHasAndBelongsToMany'     =>  AK_LIB_DIR.DS.'AkActiveRecord'.DS.'AkAssociations'.DS.'AkHasAndBelongsToMany.php',
            'AkHasMany'                 =>  AK_LIB_DIR.DS.'AkActiveRecord'.DS.'AkAssociations'.DS.'AkHasMany.php',
            'AkHasOne'                  =>  AK_LIB_DIR.DS.'AkActiveRecord'.DS.'AkAssociations'.DS.'AkHasOne.php',
            ...
            'AkProfiler'                =>  AK_LIB_DIR.DS.'AkProfiler.php',
