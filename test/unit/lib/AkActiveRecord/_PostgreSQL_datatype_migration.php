...
{
    var $WeHaveAPostgreSqlEnvironment;
    ...
    function test_integers_and_booleans_should_not_be_numerics()
    {
    ...
    function test_should_return_simplified_akelos_datatypes()
    {
        if (!$this->WeHaveAPostgreSqlEnvironment) return;
    ...
    function test_should_migrate_integers()
    {
        if (!$this->WeHaveAPostgreSqlEnvironment) return;
