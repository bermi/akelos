...
class AkActiveRecord_nested_finders_TestCase extends  AkUnitTest
{
    ...
    function test_find_aa_include_bbs()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
    ...
    function test_find_aa_include_bbs_and_ccs_and_dds()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_aa_include_bbs_and_ccs_and_dds_and_ees()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_aa_include_bbs_and_ccs_and_dds_and_ees_and_back_to_aa()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
