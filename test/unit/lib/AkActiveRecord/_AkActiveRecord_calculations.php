...
class test_AkActiveRecord_calculations extends  AkUnitTest
{
    ...
    function test_should_sum_field()
    {
        $this->assertEqual(318, $this->Account->sum('credit_limit'));
    }

    function test_should_average_field()
    {
    ...
    function test_should_get_maximum_of_field()
    {
        $this->assertEqual(60, $this->Account->maximum('credit_limit'));
    }

    function test_should_get_minimum_of_field()
    {
        $this->assertEqual(50, $this->Account->minimum('credit_limit'));
    }

    function test_should_group_by_field()
    {
    ...
    function test_should_limit_calculation_with_offset()
    {
    ...
    function test_should_group_by_summed_field_having_condition()
    {
    ...
    function test_should_sum_field_with_conditions()
    {
        $this->assertEqual(105, $this->Account->sum('credit_limit',array('conditions' => "firm_id = 6")));
    }
    
    function test_should_group_by_summed_field_with_conditions()
    {
    ...
    function test_should_group_by_summed_field_with_conditions_and_having()
    {
    ...
    function test_should_group_by_fields_with_table_alias()
    {
    ...
    function test_should_calculate_with_invalid_field()
    {
        $this->assertEqual(6, $this->Account->calculate('count','*'));
        $this->assertEqual(6, $this->Account->calculate('count','all'));
    }

    function test_should_calculate_grouped_with_invalid_field()
    {
