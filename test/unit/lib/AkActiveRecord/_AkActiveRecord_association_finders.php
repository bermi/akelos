...
class AkActiveRecord_association_finders_TestCase extends  AkUnitTest
{
    ...
    function test_find_on_first_level_has_many_finder_with_conditions()
    {
    ...
    function test_find_on_first_level_has_many_finder_with_conditions_as_array()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_on_first_level_has_many_finder_with_conditions_and_bind()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_on_first_level_has_many_finder_with_order()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_on_first_level_has_many_finder_with_include()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
     ...
     *
     */
    function test_find_on_first_level_has_many_finder_with_id_and_include()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_on_second_level_habtm_finder_with_conditions_and_bind()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
     ...
     *
     */
    function test_find_on_second_level_habtm_finder_with_id()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
    ...
    function test_find_on_second_level_habtm_finder_with_conditions_as_array()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
     ...
     *
     */
    function xtest_find_on_second_level_habtm_finder_with_conditions_as_array_and_include()
    {
        $aa = &$this->Aa->create(array('name'=>'first aa'));
        $this->assertTrue($aa);
        $bb1 = &$this->Bb->create(array('name'=>'first bb'));
