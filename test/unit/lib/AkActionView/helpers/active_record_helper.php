...
include_once dirname(__FILE__).'/_HelpersUnitTester.php';

Mock::generate('AkRequest');

class ActiveRecordHelper_TestCase extends HelpersUnitTester
{
    public function test_setup()
    {
        ...
        $this->controller->Property = new Property(array('description' =>'阿尔罕布拉宫','details' => '阿尔罕布拉宫 <> & (阿拉伯语: الحمراء‎‎ = Al Ħamrā\'; 即"红色城堡")'));
