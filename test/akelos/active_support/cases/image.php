...
class Image_TestCase extends ActiveSupportUnitTest
{
    public function __construct() {
        ...
        if(!($this->offline_mode = !(@file_get_contents('http://www.akelos.org/testing_resources/images/watermark.png')))){
            ...
            if(!empty($cristobal)) AkFileSystem::file_put_contents($this->photo_path, $cristobal, array('base_path'=>AK_FRAMEWORK_DIR));
            $watermark = @Ak::url_get_contents('http://www.akelos.org/testing_resources/images/watermark.png', array('cache'=>100000));
            if(!empty($watermark)) AkFileSystem::file_put_contents($this->watermark, $watermark, array('base_path'=>AK_FRAMEWORK_DIR));
    ...
    public function test_image_save_as() {
        ...
        $PngImage->save($this->image_path.'.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        $JpgImage = new AkImage($this->image_path.'.jpg');
        $this->assertEqual($JpgImage->getExtension(), 'jpg');

        $PngImage = new AkImage($this->image_path);
        $PngImage->save($this->image_path.'.gif', 100, array('base_path'=>AK_FRAMEWORK_DIR));
    ...
    public function test_image_resize() {
        ...
        $Image->save($this->image_path.'_50x22.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->image_path.'_85x37.png', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->image_path.'_300x300.png', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->image_path.'_x300.png', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->image_path.'_680x300.png', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->image_path.'_340x150.png', 100, array('base_path'=>AK_FRAMEWORK_DIR));
    ...
    public function test_image_crop() {
        ...
        $Image->save($this->photo_path.'_30x30_crop.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->photo_path.'_50_crop.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
        ...
        $Image->save($this->photo_path.'top_crop.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
    ...
    public function test_image_watermark() {
        ...
        $Image->save($this->photo_path.'_watermarked.jpg', 100, array('base_path'=>AK_FRAMEWORK_DIR));
    ...
    public function test_should_apply_native_filters() {
        ...
        foreach ($native_filters as $native_filter => $options){
            ...
            if($Image->isNativeFiler($native_filter)){
                ...
                $Image->save($image_path, 100, array('base_path'=>AK_FRAMEWORK_DIR));
