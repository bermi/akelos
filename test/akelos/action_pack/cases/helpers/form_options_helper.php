...
class FormOptionsHelper_TestCase extends HelperUnitTest
{
    public function test_for_formOptionsHelper()
    {
        ...
        file_get_contents(HelperUnitTest::getFixturesDir().DS.'form_options_helper_to_select_prompt.txt')
        );

        $this->assertEqual(
        $AkFormHelperOptionsInstanceTag->to_select_tag(array('a','b'), array(), array('include_blank' => true)),
        file_get_contents(HelperUnitTest::getFixturesDir().DS.'form_options_helper_to_select_include_blank.txt')
        );

        $this->assertEqual(
        $AkFormHelperOptionsInstanceTag->to_select_tag(array('a','b'), array(), array('include_blank' => true, 'prompt' => true)),
        file_get_contents(HelperUnitTest::getFixturesDir().DS.'form_options_helper_to_select_include_blank_prompt.txt')
        );
...
ak_test_case('FormOptionsHelper_TestCase');
