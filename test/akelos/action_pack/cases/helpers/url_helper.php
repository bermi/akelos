...
class UrlHelper_TestCase extends HelperUnitTest
{
    ...
    public function test_for_UrlHelper()
    {
        ...
        $this->assertTrue(strstr($this->url->link_to('Help', array('action' => 'help'), array('post' => true)),'<a href="/url/for/test" onclick="var f = document.createElement(\'form\'); f.style.display = \'none\'; this.parentNode.appendChild(f); f.method = \'POST\'; f.action = this.href;var m = document.createElement(\'input\'); f.appendChild(m);var s = document.createElement(\'input\'); s.setAttribute(\'type\', \'hidden\'); s.setAttribute(\'name\', \'authenticity_token\'); s.setAttribute(\'value\', \''));
        $this->assertTrue(strstr($this->url->link_to('Help', array('action' => 'help'), array('post' => true)),'f.appendChild(s);f.submit();return false;">Help</a>'));
        ...
        $this->assertEqual($this->url->mail_to('me@domain.com', 'My email', array('encode' => 'javascript')),"<script type=\"text/javascript\">eval(unescape('%64%6f%63%75%6d%65%6e%74%2e%77%72%69%74%65%28%27%3c%61%20%68%72%65%66%3d%5c%22%6d%61%69%6c%74%6f%3a%6d%65%40%64%6f%6d%61%69%6e%2e%63%6f%6d%5c%22%3e%4d%79%20%65%6d%61%69%6c%3c%2f%61%3e%27%29%3b'))</script>");
...
ak_test_case('UrlHelper_TestCase');
